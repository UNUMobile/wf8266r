...
void ESP8266_ILI9341::transmitCmdData(uint8_t cmd, const uint8_t *data, uint8_t numDataByte)
{
	spi_wait_ready();
	TFT_DC_COMMAND;
	spi_send_uint8(cmd);
...
void ESP8266_ILI9341::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
void ESP8266_ILI9341::drawFastVLine(int16_t x, int16_t y, int16_t h,
		uint16_t color) {
...
void ESP8266_ILI9341::drawFastHLine(int16_t x, int16_t y, int16_t w,
		uint16_t color) {
...
void ESP8266_ILI9341::fillScreen(uint16_t color) {
	fillRect(0, 0,  _width, _height, color);
}

// fill a rectangle
void ESP8266_ILI9341::fillRect(int16_t x, int16_t y, int16_t w, int16_t h,
		uint16_t color) {
...
uint16_t ESP8266_ILI9341::color565(uint8_t r, uint8_t g, uint8_t b) {
...
void ESP8266_ILI9341::setRotation(uint8_t m) {
...
void ESP8266_ILI9341::invertDisplay(boolean i) {
