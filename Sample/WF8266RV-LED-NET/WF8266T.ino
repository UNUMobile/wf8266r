...
void displayNumber(String number)
{
  for (uint8_t i = 0; i < number.length() ; i++)
  {
    ...
    {
      switch ((char)number[i])
      {
        case 32 : displayBuffer[i] = 10; break; //space
        case 43 : displayBuffer[i] = 10; break; //+ -> space
        case 45 : displayBuffer[i] = 15; break; //-
        case 46 : displayBuffer[i] = 13; break; //.
        case 58 : displayBuffer[i] = 11; break; //:
        case 67 : displayBuffer[i] = 12; break; //. UP C to .
        case 95 : displayBuffer[i] = 10; break; //_ -> space
        default : displayBuffer[i] = number[i] - 48;
          break;
      }
    }
  }
